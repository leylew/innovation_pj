...
class Image2Text(QWidget):
    ...
    def __init__(self):
        ...
        # 修改文本框文字大小
        self.ui.textEdit.setFont(QFont('Consolas', 14))

        self.ui.textEdit.setAcceptDrops(False)
        self.ui.textEdit.setPlaceholderText('1.Put the image to be identified here...\n' + '2.Screen capture shortcut: ' + SCREEN_SHOT_SHORTCUT)
        ...
        self.beautify_button(self.ui.pushButtonCapture1, SCREEN_SHOT_ICON_URL)
    ...
    @pyqtSlot()
    def on_pushButtonCapture1_clicked(self):
        self.capture = CaptureScreen()
        self.capture.signal_complete_capture.connect(self.__slot_screen_capture)
